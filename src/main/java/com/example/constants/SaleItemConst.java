...
public class SaleItemConst {
    ...
    public  static final  String SQLUPDATE="UPDATE sale_item SET itemName = ?, price = ?, vat=? WHERE itemId = ?";
    public  static final  String SQLCHECK="SELECT COUNT(*) FROM sale_item WHERE itemName=? AND price=? AND vat=?";
